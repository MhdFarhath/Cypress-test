                                          ...
                                          cy.get('.ant-upload > .ant-btn').click({force: true})
                                              ...
                                              .then(() => {
                                                  ...
                                                  cy.get('.ant-form-item-control-input-content > .ant-btn').click({force: true})
                                                      .then(() => {
                                                          cy.get('[data-row-key="8"] > :nth-child(8) > .ant-btn')
                                                              .click({ force: true })
                                                              .then(() => {
                                                                  cy.get('#Sku_max_level').type('100', { force: true });
                                                              });
                                                          ...
                                                          cy.get('.ant-popover-buttons > .ant-btn-primary').click({force: true})
                                                              ...
                                                              .then(() => {
                                                                  cy.get('.MuiIconButton-edgeStart').click()
                                                                  cy.get('[href="/expoloader/containerpage"]').click({force:true})
                                                                      .then(() =>{

                                                                          cy.get('.MuiIconButton-edgeStart').click({force:true})
                                                                              .then( () =>  {
                                                                                  cy.get('[href="/expoloader/optimizationpage"] > .MuiListItem-root').click({force:true})
                                                                                      .then(() => {
                                                                          ...
                                                                          // cy.get('.css-15d7jfu > .user-info-view > .css-759u60').click({force:true})
